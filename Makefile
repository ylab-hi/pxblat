...
COPTS=-O2 -Isrc/pyblat/extc/include/core -Isrc/pyblat/extc/include/aux -Isrc/pyblat/extc/include/net -Isrc/pyblat/extc/bindings $(HG_DEFS)  -Wunused-variable
...
faToTwoBit: bin ## Build faToTwoBit
	$(CC) $(COPTS) $(CFLAGS) src/pyblat/extc/faToTwoBit.c src/pyblat/extc/src/core/*.c $(AUXSRC) src/pyblat/extc/src/net/*.c  -o bin/faToTwoBit -lm -pthread -lhts -lssl -lcrypto
...
gfClient: bin ## Build gfClient
	$(CC) $(COPTS) $(CFLAGS) src/pyblat/extc/gfClient.c src/pyblat/extc/src/core/*.c $(AUXSRC) src/pyblat/extc/src/net/*.c  -o bin/gfClient -lm -pthread -lhts -lssl -lcrypto
