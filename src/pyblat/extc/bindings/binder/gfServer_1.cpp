...
{
	// cppbinding::pystatusServer(std::string &, std::string &, struct cppbinding::gfServerOption &) file:gfServer.hpp line:228
	...
	// cppbinding::pygetFileList(std::string &, std::string &) file:gfServer.hpp line:229
	...
	// cppbinding::pyqueryServer(std::string &, std::string &, std::string &, std::string &, bool, bool) file:gfServer.hpp line:230
