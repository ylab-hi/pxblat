...
void bind_gfServer_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// cppbinding::pystatusServer(std::string &, std::string &, struct cppbinding::gfServerOption &) file:gfServer.hpp line:243
	...
	// cppbinding::pygetFileList(std::string &, std::string &) file:gfServer.hpp line:244
	...
	// cppbinding::pyqueryServer(std::string &, std::string &, std::string &, std::string &, bool, bool) file:gfServer.hpp line:245
