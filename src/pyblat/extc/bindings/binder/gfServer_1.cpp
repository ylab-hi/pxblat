...
{
	// cppbinding::getPortIx(char *) file:gfServer.hpp line:197
	M("cppbinding").def("getPortIx", (int (*)(char *)) &cppbinding::getPortIx, "C++: cppbinding::getPortIx(char *) --> int", pybind11::arg("portName"));

	// cppbinding::pystatusServer(std::string &, std::string &, struct cppbinding::gfServerOption &) file:gfServer.hpp line:244
	...
	// cppbinding::pygetFileList(std::string &, std::string &) file:gfServer.hpp line:245
	...
	// cppbinding::pyqueryServer(std::string &, std::string &, std::string &, std::string &, bool, bool) file:gfServer.hpp line:246
